...
class ArbiterPanel(ttk.LabelFrame):
    ...
    def __init__(
        ...
        *,
        ...
        self.var_self_epochs = tk.IntVar(value=int(cfg.max_self_train_epochs))
        ...
        ttk.Scale(rowf, from_=0.0, to=0.20, variable=self.var_strong_margin,
                  command=lambda *_: self._sync_label(l_sm, self.var_strong_margin)).grid(row=1, column=1, sticky="we", padx=6)
